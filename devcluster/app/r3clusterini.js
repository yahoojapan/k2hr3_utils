...
class R3clusterIni {
	...
	constructor(ini, component) {
		...
		try {
			let extfile = path.join(srcdir, 'r3clusterini_k2hr3_app_ext.js');
			fs.accessSync(extfile, fs.constants.R_OK);

			// 1. filename
			// r3clusterini_k2hr3_app_ext.js
			...
			console.log('no access to k2hr3_app_local_json_ext.js, just skipping it;)');
		}
	}
